                ...
                <form method="POST" action="{{ route('teacher.games.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex flex-col md:flex-row gap-3 mb-3">
                            <input type="text" name="words[]" class="w-full md:flex-1 md:max-w-xs bg-pink-50 border-2 border-pink-200 rounded-xl px-4 py-5 text-gray-800 font-medium shadow-md hover:bg-pink-100 focus:border-teal-400 focus:ring-2 focus:ring-teal-200 focus:bg-pink-50 transition-all" placeholder="Word" required>
                            <input type="text" name="definitions[]" class="w-full md:flex-1 md:max-w-2xl bg-pink-50 border-2 border-pink-200 rounded-xl px-4 py-5 text-gray-800 font-medium shadow-md hover:bg-pink-100 focus:border-teal-400 focus:ring-2 focus:ring-teal-200 focus:bg-pink-50 transition-all" placeholder="Definition" required>
                        </div>
                        <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAddPairBtn(e) {
        ...
        console.log('Add Pair button clicked');
            ...
            pairDiv.className = 'flex flex-col md:flex-row gap-3 p-4 bg-gradient-to-r from-pink-50 to-teal-50 border-2 border-teal-200 rounded-xl hover:border-teal-300 transition-colors';
            pairDiv.innerHTML = `
                <input type='text' name='words[]' value='${escapeHtml(wordValue)}' class='w-full md:flex-1 md:max-w-2xl border-2 border-teal-300 rounded-lg px-4 py-5 text-teal-900 font-semibold bg-pink-50' required readonly> 
                <input type='text' name='definitions[]' value='${escapeHtml(defValue)}' class='w-full md:flex-1 md:max-w-2xl border-2 border-teal-300 rounded-lg px-4 py-5 text-teal-900 font-semibold bg-pink-50' required readonly> 
                ...
                if (form) {
                    ...
                    if (pairsList && wordInput && defInput) {
                        ...
                        if (wordVal && defVal) {
                            ...
                            pairDiv.innerHTML = '<input type="text" name="words[]" value="' + wordValEscaped + '" class="w-full md:flex-1 md:max-w-2xl border-2 border-teal-300 rounded-lg px-4 py-5 text-teal-900 font-semibold bg-pink-50" required readonly><input type="text" name="definitions[]" value="' + defValEscaped + '" class="w-full md:flex-1 md:max-w-2xl border-2 border-teal-300 rounded-lg px-4 py-5 text-teal-900 font-semibold bg-pink-50" required readonly><button type="button" class="removePairBtn px-3 py-2 bg-gradient-to-r from-red-200 via-red-300 to-red-300 text-white rounded-lg font-bold shadow-md hover:from-red-300 hover:via-red-400 hover:to-red-400 transform hover:scale-105 transition-all duration-200 border border-red-200/50 flex items-center justify-center" title="Remove this pair"><svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg></button>';
                            pairsList.appendChild(pairDiv);
                            wordInput.value = '';
                            defInput.value = '';
                            pairDiv.querySelector('.removePairBtn').onclick = function() { pairDiv.remove(); };
