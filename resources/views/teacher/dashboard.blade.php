...
<div class="min-h-screen bg-gradient-to-br from-pink-50 via-cyan-50/30 to-teal-50/20 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <!-- Total Classes Card -->
            <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-pink-200/40 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:scale-105 animate-fade-in-up" style="animation-delay: 0.1s;">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-pink-300 to-rose-300 rounded-xl flex items-center justify-center shadow-md transform rotate-3 hover:rotate-6 transition-transform">
                ...
                <div class="text-pink-600 text-xs font-bold uppercase tracking-wider mb-2">Total Classes</div>
                <div class="text-4xl font-black text-gray-800 mb-1">{{ $totalClasses }}</div>
                <div class="text-sm text-gray-600 font-medium">Active classes you teach</div>
            </div>

            <!-- Total Students Card -->
            <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-cyan-200/40 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:scale-105 animate-fade-in-up" style="animation-delay: 0.2s;">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-cyan-300 to-teal-300 rounded-xl flex items-center justify-center shadow-md transform -rotate-3 hover:-rotate-6 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="text-cyan-600 text-xs font-bold uppercase tracking-wider mb-2">Total Students</div>
                <div class="text-4xl font-black text-gray-800 mb-1">{{ $totalStudents }}</div>
                <div class="text-sm text-gray-600 font-medium">Students across all classes</div>
            </div>

            <!-- Total Assignments Card -->
            <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-pink-200/40 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:scale-105 animate-fade-in-up" style="animation-delay: 0.3s;">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-pink-300 to-cyan-300 rounded-xl flex items-center justify-center shadow-md transform rotate-3 hover:rotate-6 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="text-pink-600 text-xs font-bold uppercase tracking-wider mb-2">Total Assignments</div>
                <div class="text-4xl font-black text-gray-800 mb-1">{{ $totalAssignments }}</div>
                <div class="text-sm text-gray-600 font-medium">Assignments created</div>
            </div>

            <!-- Total Quizzes Card -->
            <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-teal-200/40 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:scale-105 animate-fade-in-up" style="animation-delay: 0.4s;">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-teal-300 to-cyan-300 rounded-xl flex items-center justify-center shadow-md transform -rotate-3 hover:-rotate-6 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="text-teal-600 text-xs font-bold uppercase tracking-wider mb-2">Total Quizzes</div>
                <div class="text-4xl font-black text-gray-800 mb-1">{{ $totalQuizzes }}</div>
                <div class="text-sm text-gray-600 font-medium">Quizzes created</div>
            </div>

            <!-- Pending Assignment Grading Card -->
            <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-red-200/40 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:scale-105 animate-fade-in-up" style="animation-delay: 0.5s;">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-red-400 to-orange-400 rounded-xl flex items-center justify-center shadow-md transform rotate-3 hover:rotate-6 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                    </div>
                ...
                <div class="text-red-600 text-xs font-bold uppercase tracking-wider mb-2">Pending Assignment Grading</div>
                <div class="text-4xl font-black text-gray-800 mb-1">{{ $pendingGrading ?? 0 }}</div>
                <div class="text-sm text-gray-600 font-medium">Assignments awaiting review</div>
            </div>

            <!-- Average Grade Card -->
            <div class="bg-gradient-to-br from-pink-200/90 via-rose-200/80 to-cyan-200/90 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-pink-200/60 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:scale-105 animate-fade-in-up" style="animation-delay: 0.6s;">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-14 h-14 bg-white/50 backdrop-blur-md rounded-xl flex items-center justify-center shadow-md transform -rotate-3 hover:-rotate-6 transition-transform border border-white/60">
                ...
                <div class="text-pink-700 text-xs font-bold uppercase tracking-wider mb-2">Average Grade</div>
                <div class="text-4xl font-black bg-gradient-to-r from-pink-600 to-cyan-600 bg-clip-text text-transparent mb-1">{{ number_format($averageGrade, 1) }}%</div>
                <div class="text-sm text-gray-700 font-medium">Average across all grades</div>
            </div>
        </div>
